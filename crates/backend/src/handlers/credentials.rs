...
pub enum ProvisionResponse {
    ...
    /// OAuth2 service — needs a consent flow (guided handoff, not yet self-serve).
...
pub async fn provision(
    ...
    let resp = match cap {
        ...
        Some(_) => ProvisionResponse::OauthRequired {
            service,
            message: "Ce service nécessite une connexion OAuth à autoriser — assistance guidée bientôt disponible.".into(),
        },
        None => ProvisionResponse::Manual {
            service,
